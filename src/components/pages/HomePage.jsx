...
export const HomePage = () => {
  return (
    <main className="flex flex-col justify-center items-center gap-10 bg-gifBlue ">
      <h1 className='font-gifTitles text-2xl sm:text-5xl'>Seleccione una categoria</h1>
      <section className='flex flex-col sm:flex-row justify-center items-center gap-10'>
        ...
        <div className='font-montserrat max-w-xs sm:max-w-[74ch] text-center text-gifWhite text-lg'>
